...
CALIB_PATH = PROJECT_ROOT / "runs/pipeline2/08_calibcam_all7_pinhole_from_fullsensor_lensboy_min12/multicam_calibration.npy"
DET_DIR = PROJECT_ROOT / "runs/pipeline2/07_calibcam_from_fullsensor_lensboy_min12"
OUT_DIR = PROJECT_ROOT / "runs/pipeline2/09_reprojection_diagnostics_min12"
